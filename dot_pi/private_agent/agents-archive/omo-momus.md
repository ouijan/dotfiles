---
name: omo-momus
description: Expert reviewer for evaluating work plans against rigorous clarity, verifiability, and completeness standards (ported from oh-my-opencode)
tools: read, grep, find, ls
model: openrouter/openai/gpt-5.5
fallbackModels: anthropic/claude-opus-4-8, openrouter/google/gemini-3.1-pro-preview, openrouter/z-ai/glm-5.1
thinking: xhigh
...
**PASS even if**: Reference exists but isn't perfect. Developer can omo-explore from there.
