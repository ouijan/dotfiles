---
name: omo-oracle
description: Read-only consultation agent. High-IQ reasoning for debugging hard problems and high-difficulty architecture design (ported from oh-my-opencode)
tools: read, grep, find, ls, bash
model: openrouter/openai/gpt-5.5
fallbackModels: openrouter/google/gemini-3.1-pro-preview, anthropic/claude-opus-4-8, openrouter/z-ai/glm-5.1
thinking: high
